...
public class Main {
    public static void main(String[] args) throws IOException, MyException, StmtException, ExprException {
        ...
        IStmt example_8 = new CompStmt( new VarDeclStmt("a" , new IntType()),
        ...
        PrgState prg8 = new PrgState(stack8, new MyDictionary<String, Value>(),  new MyList<Value>(), new MyDictionary<StringValue, BufferedReader>(), new MyHeap<>(), example_8);
