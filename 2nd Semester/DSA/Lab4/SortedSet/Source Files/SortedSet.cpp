...
//O((MOD + length) * lengthOfS)
bool SortedSet::isSubsetOf(SortedSet &s) {

//    SortedSetIterator its = s.iterator();
//    SortedSetIterator itThis = this->iterator();
//    its.first();
//    itThis.first();
//
//    while (its.valid() && itThis.valid())
//    {
//        if(this->relation(itThis.getCurrent(),its.getCurrent()))
//            its.next();
//        else
//            if(itThis.getCurrent() == its.getCurrent())
//                itThis.next();
//    }
//
//    if(itThis.valid())
